...
class VoixFlashApp(rumps.App):
    ...
    def show_guide(self, _sender):
        ...
        guide = (
            ...
            "  • Ça travaille en arrière-plan, sans bloquer le Mac ; l'avancement\n"
            "    s'affiche en pourcentage dans le menu.\n"
            "  • Tu peux ARRÊTER à tout moment (la même ligne du menu devient « Annuler\n"
            "    la transcription en cours ») : le texte déjà écrit est conservé.\n"
            "  • Un fichier long est découpé tout seul : même 2 h et plus passent sans\n"
            "    ralentir le Mac.\n"
            "\n"
            ...
            "\n"
            "• Une RÉUNION s'arrête TOUTE SEULE après 3 HEURES, au cas où le micro\n"
            "  aurait été oublié. Au-delà, relance une réunion.\n"
            "• Une dictée éclair dont la touche reste enfoncée plus de 2 MINUTES\n"
            "  s'arrête aussi automatiquement.\n"
            "• MICRO MUET : si le micro ne transmet RIEN du tout (mauvaise entrée choisie,\n"
            "  micro occupé par un appel vidéo), VoixFlash te le dit au lieu d'écrire une\n"
            "  phrase inventée. Se taire quelques secondes reste normal : c'est l'absence\n"
            "  totale de signal qui est détectée, pas le silence.\n"
            "• SILENCE / BRUIT : si rien d'audible n'est dit, RIEN n'est écrit. Un\n"
            "  filtre écarte aussi les phrases parasites inventées sur du silence\n"
            "  (ex. « Sous-titres réalisés par… ») : elles ne sont pas écrites.\n"
            "• Juste après le démarrage du Mac, la toute première dictée peut tarder\n"
            "  d'une seconde, le temps que VoixFlash finisse de se préparer.\n"
            "• IMPORT D'UN FICHIER : ça prend du temps. Compte environ 15 min pour\n"
            "  1 h d'enregistrement en qualité « Précis » ; « Très précis » est plus lent.\n"
            "  Un fichier de 2 h passe sans souci. Au-delà de 30 min, VoixFlash annonce\n"
            "  une estimation avant de lancer.\n"
            ...
            f"  {imports_state}). Compte un quart d'heure de plus par heure\n"
            "  d'enregistrement. « Locuteur 2 » désigne bien la même personne du début\n"
            "  à la fin du fichier.\n"
            "  Les fichiers protégés contre la copie (Apple Music) sont refusés.\n"
            "\n"
            "• SÉPARER LES LOCUTEURS : « Réunions › Séparer les locuteurs » télécharge une\n"
            "  seule fois un petit complément (environ 50 Mo, sans compte à créer) et\n"
            "  affiche ensuite « — Locuteur 1 : … », « — Locuteur 2 : … ».\n"
            ...
            f"  « Locuteurs attendus » (actuellement : {plafond_state}) est un MAXIMUM,\n"
            "  pas un nombre exact : il évite qu'une même personne soit comptée pour\n"
            "  deux, mais ne force jamais à regrouper. Choisis « 1 » si tu étais seul.\n"
            "  Dans le doute, laisse « Automatique ».\n"
            ...
            "  partout. Donne le MÊME nom à deux locuteurs pour les REGROUPER : c'est la\n"
            "  réparation à faire quand une seule personne a été comptée deux fois.\n"
            ...
            "   • micro fin (contour) ........ VoixFlash se prépare\n"
            "   • micro plein ................ prêt\n"
            ...
            "Pendant un import ou la transcription d'une réunion, le menu affiche\n"
            "l'avancement en pourcentage, et la ligne devient un bouton d'annulation.\n"
            ...
            "\n"
            "Quand tu CHANGES de qualité, l'icône revient au micro fin le temps de la\n"
            "préparer. La TOUTE PREMIÈRE fois qu'on choisit une qualité, elle est\n"
            "téléchargée (jusqu'à 1 min ; « Très précis » pèse 1,5 Go) ; un message le\n"
            "signale. Ensuite c'est immédiat. « Modèle prêt » confirme que tu peux dicter.\n"
            "\n"
            "━━━ 5. L'HISTORIQUE ━━━\n"
            "\n"
            ...
            "━━━ 6. LES RÉGLAGES ━━━\n"
            "\n"
            f"• Qualité / vitesse : de Rapide à Très précis. Actuel : {model}.\n"
            ...
            "   – MÉLANGER les deux langues DANS la même phrase marche mal : une seule\n"
            "     l'emporte. Une qualité plus élevée aide un peu.\n"
            ...
            "• Réunions › Horodatage des passages : ajoute l'heure (03:12) au début de\n"
            f"  chaque paragraphe. Actuel : {ts_state}.\n"
            "• Texte dicté › Ajouter un mot au vocabulaire… : écris un nom propre, une\n"
            "  marque ou un mot de ton métier tel que tu veux le voir. Les variantes\n"
            "  proches seront corrigées, même quand il est entendu en deux morceaux\n"
            "  (« voie flash » devient « VoixFlash »). C'est LE réglage qui change tout\n"
            "  sur les noms.\n"
            "• Texte dicté › Corriger une faute récurrente… : remplace un mot mal\n"
            "  transcrit par le bon, à tous les coups. Sert aussi de raccourci : une\n"
            "  phrase courte qui devient un texte long (signature, adresse).\n"
            ...
            "\n"
            "Rien de ce que tu dictes n'est jamais enregistré dans un journal. Le fichier\n"
            "de diagnostic ne note que si le micro a transmis du son, et quand. Il est\n"
            "effacé au bout de sept jours.\n"
            "\n"
